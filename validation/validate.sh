...
CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate.py llama_7B --num_heads 0 --alpha 0 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 


# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 12 --alpha 5 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 24 --alpha 5 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 36 --alpha 5 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 46 --alpha 5 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info

# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 12 --alpha 10 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 24 --alpha 10 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 36 --alpha 10 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 46 --alpha 10 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info

# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 12 --alpha 15 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 24 --alpha 15 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 36 --alpha 15 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
# CUDA_VISIBLE_DEVICES=0 python validate_2fold_hate_info.py llama_7B --num_heads 46 --alpha 15 --dataset_name hateqa_mc2 --device 0 --num_fold 2 --use_center_of_mass --num_fewshot 0 --seed 5 --info_name GPT-info
